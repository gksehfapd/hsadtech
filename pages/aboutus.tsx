...
const AboutUs = () => {
	return (
		<Layout className="p-8">
			<div className="flex flex-col pb-32 max-md:pb-10">
			...
			<div className="flex w-full justify-around text-center max-md:grid max-md:grid-cols-4 max-md:gap-y-12 max-md:gap-x-8 pb-20">
